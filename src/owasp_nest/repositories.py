...
class Repositories(BaseSDK):
    def list_repositories(
        ...
        *,
        ...
        :param organization_id: Organization that repositories belong to
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.PagedRepository, http_res)
    ...
    def get_repository(
        ...
        *,
        ...
        request = models.GetRepositoryRequest(
            organization_id=organization_id,
        ...
        req = self._build_request(
            method="GET",
            path="/api/v0/repositories/{organization_id}/{repository_id}",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=False,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.RepositoryDetail, http_res)
        if utils.match_response(http_res, "404", "application/json"):
            response_data = unmarshal_json_response(
                models.RepositoryErrorData, http_res
            )
            raise models.RepositoryError(response_data, http_res)
        if utils.match_response(http_res, "4XX", "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise models.NestAPIError("API error occurred", http_res, http_res_text)
        if utils.match_response(http_res, "5XX", "*"):
