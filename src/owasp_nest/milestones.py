...
class Milestones(BaseSDK):
    def list_milestones(
        ...
        *,
        ...
        state: OptionalNullable[models.IssueState] = UNSET,
        ordering: OptionalNullable[models.ListMilestonesOrdering] = UNSET,
        page: Optional[int] = 1,
    ...
    ) -> models.PagedMilestone:
        r"""List milestones

        Retrieve a paginated list of GitHub milestones.

        :param organization: Organization that milestones belong to (filtered by repository owner)
        :param repository: Repository that milestones belong to
        ...
        request = models.ListMilestonesRequest(
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.PagedMilestone, http_res)
    ...
    async def list_milestones_async(
        self,
        *,
        organization: OptionalNullable[str] = UNSET,
        repository: OptionalNullable[str] = UNSET,
    ...
    def get_milestone(
        ...
        *,
        ...
        request = models.GetMilestoneRequest(
        ...
        req = self._build_request(
            method="GET",
            path="/api/v0/milestones/{organization_id}/{repository_id}/{milestone_id}",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=False,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.MilestoneDetail, http_res)
        ...
        if utils.match_response(http_res, "404", "application/json"):
            response_data = unmarshal_json_response(models.MilestoneErrorData, http_res)
            raise models.MilestoneError(response_data, http_res)
        if utils.match_response(http_res, "4XX", "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise models.NestAPIError("API error occurred", http_res, http_res_text)
        if utils.match_response(http_res, "5XX", "*"):
