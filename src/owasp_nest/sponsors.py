...
class Sponsors(BaseSDK):
    def list_sponsors(
        self,
        *,
        is_member: OptionalNullable[bool] = UNSET,
        member_type: OptionalNullable[models.MemberType] = UNSET,
        ...
        :param is_member: Member status of the sponsor
        ...
        request = models.ListSponsorsRequest(
            is_member=is_member,
