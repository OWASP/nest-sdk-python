...
class ListOrganizationsOrdering(str, Enum):
    r"""Ordering field"""
...
class ListOrganizationsRequestTypedDict(TypedDict):
    ...
    r"""Location of the organization"""
...
class ListOrganizationsRequest(BaseModel):
    ...
    ordering: Annotated[
        OptionalNullable[ListOrganizationsOrdering],
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = UNSET
    r"""Ordering field"""
    ...
    def serialize_model(self, handler):
        optional_fields = set(["location", "ordering", "page", "page_size"])
        nullable_fields = set(["location", "ordering"])
