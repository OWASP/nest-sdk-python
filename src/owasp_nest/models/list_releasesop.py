...
class ListReleasesOrdering(str, Enum):
    r"""Ordering field"""
...
class ListReleasesRequest(BaseModel):
    ...
    ordering: Annotated[
        OptionalNullable[ListReleasesOrdering],
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = UNSET
    r"""Ordering field"""
    ...
    def serialize_model(self, handler):
        optional_fields = set(
            ["organization", "repository", "tag_name", "ordering", "page", "page_size"]
        )
        nullable_fields = set(["organization", "repository", "tag_name", "ordering"])
